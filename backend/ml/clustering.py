...
def build_student_features():
    ...
    for student in students:
        ...
        # Average days early (negative = submitted late)
        days_list = []
...
def cluster_students():
    ...
    # Label clusters by average completion rate
...
def detect_outliers():
    ...
    detect students with unusual behavior patterns.
    """
    df = build_student_features()
