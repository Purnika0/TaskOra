...
// Feature-specific empty state shown when a backend validation threshold
// isn't met (e.g. not enough students with task data yet) instead of a
...
export default function AnalyticsPage() {
    ...
    // Student analytics lives in its own dedicated component/page.
            ...
            {isTeacher && (
                <>
                    ...
                    <div className="analytics-2x2-grid">
                        ...
                        {/* Full ranking — the Teacher Dashboard only shows the top 5 */}
